<?php
/**
 * FuncionarioFormList Form List
 * @author  <your name here>
 */
class FuncionarioFormList extends TPage
{
	protected $form; // form
	...
	public function __construct( $param )
	{
		...
		$dataNasc->setOption('triggerEvent', 'dblclick');
		...
		$this->form->addFields( [ new TLabel('Cartão SUS') ], [ $cartaoSus ] );
		$this->form->addFields( [ new TLabel('Data Nasc.') ], [ $dataNasc ] );
		$this->form->addFields( [ new TLabel('Data Admissão') ], [ $dataAdmissao ] );
		...
		$column_dataNasc->setTransformer(
		...
		$column_cartao_sus = new TDataGridColumn('cartaoSus', 'Cartão SUS', 'left');
		...
		$this->datagrid->addColumn($column_cartao_sus);
