<?php
/**
 * PatologiaFormList Form List
 * @author  <your name here>
 */
class PatologiaFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $this->form = new BootstrapFormBuilder('form_Patologia');
        $this->form->setFormTitle('Patologia');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Patologia
            $repository = new TRepository('Patologia');
            $limit = 10;
            // creates a criteria
    ...
    public static function Delete($param)
    {
        try
        {
            ...
            $object = new Patologia($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Patologia;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('db'); // open a transaction
                $object = new Patologia($key); // instantiates the Active Record
